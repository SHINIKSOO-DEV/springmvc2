...
public class RequestParamController {
    ...
    public String requestParamMap(@RequestParam Map<String, Object> parammMap) throws IOException {

        log.info("memberName = {}, memberAge = {}", parammMap.get("userName"), parammMap.get("age"));
        return "OK";
    }
